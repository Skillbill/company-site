...
{% include image.html url="/uploads/java-16.png" width="200" height="150" caption="Caption. Nunc congue nisi vitae suscipit tellus" alt="image description" %}{: .inline .right }
