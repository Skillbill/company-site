...
(function scroll() {
  ...
  window.addEventListener('scroll', () => {
    if(document.documentElement.scrollTop <= 40 && !document.body.classList.contains('on-top')) {
      document.body.classList.add('on-top');
    } else if(document.documentElement.scrollTop > 40 && document.body.classList.contains('on-top')) {
